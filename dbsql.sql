...
INSERT INTO `tb_biodata_siswa` VALUES ('205','roki','PPLG','XI');
...
CREATE TABLE `tb_siswa` (
  ...
  `nam_siswa` varchar(50) DEFAULT NULL,
  `kelas` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`NIS`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tb_siswa` VALUES ('1001','josep mahatir','XI-RPL');
...
-- Dump completed on 2026-08-27 14:50:43
